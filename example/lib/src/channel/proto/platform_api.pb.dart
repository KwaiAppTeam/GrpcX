...
class Empty extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Empty', package: const $pb.PackageName('platform'), createEmptyInstance: create)
...
class StringValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StringValue', package: const $pb.PackageName('platform'), createEmptyInstance: create)
    ..aOS(1, 'value')
    ..hasRequiredFields = false
  ;
...
class PlatformApiChannelApi {
  $pb.RpcClient _client;
  PlatformApiChannelApi(this._client);

  $async.Future<StringValue> getPlatformVersion($pb.ClientContext ctx, Empty request) {
    var emptyResponse = StringValue();
    return _client.invoke<StringValue>(ctx, 'PlatformApiChannel', 'getPlatformVersion', request, emptyResponse);
  }
}
